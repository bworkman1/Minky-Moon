...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="canonical" href="http://lapp.cc/aana-meetings/"/>
    <meta property="og:locale" content="en_US"/>
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="LAPP - AA/NA Meetings Call today to find a meeting (740)366-7303."/>
    <meta property="og:description"
          content="LAPP - AA/NA Meetings are being conducted in the Newark, Ohio Area. Call today to find a meeting near you (740)366-7303."/>
    <meta property="og:url" content="http://lapp.cc/aana-meetings/"/>
    <meta property="og:site_name" content="LAPP | Licking County Alcoholism Prevention Program"/>
    <meta property="og:image" content="http://lapp.cc/wp-content/uploads/2014/02/quote.png"/>
    <!-- / Yoast SEO plugin. -->
...
<div class="container">
    <div class="row">
        <div class="col-sm-5">
            <img class="img-responsive logo" src="http://lapp.cc/wp-content/themes/LAPP%20Theme/img/Lapp-Logo.png"
                 alt="Lapp Logo">
        </div>
        <div class="col-sm-7">
            <div class="cloud">
                <img class="img-responsive cloud_image hidden-xs"
                     src="http://lapp.cc/wp-content/themes/LAPP%20Theme/img/Licking-County-Alcoholism-Prevention-Program.png"
                     alt="Licking County Alcoholism Prevention Program">
                <h2 class='hidden-xs'>Licking County Alcoholism Prevention Program</h2>
                <h1 class='hidden-xs'>Serving The Community Since 1968</h1>
            </div>
        </div>
    </div>
</div>
<nav class="navbar navbar-default" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://lapp.cc">
                Menu
            </a>
        </div>
            ...
            <div class='row'>
                <div id="footer-sidebar" class="secondary">
                    <div id="footer-sidebar1" class="col-sm-4">
                        <aside id="text-2" class="widget widget_text"><h3 class="widget-title">Funding</h3>
                            <div class="textwidget">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <a href="http://jfs.ohio.gov/" target="_blank">
                                            <img src="http://lapp.cc/wp-content/uploads/2014/07/odjfslogo.png"
                                                 style="padding: 6px; background: #ffffff"
                                                 class="img-responsive grayscale">
                                        </a>
                                    </div>
                                    <div class="col-xs-6">
                                        <a href="http://www.mhrlk.org/" target="_blank">
                                            <img src="http://lapp.cc/wp-content/uploads/2014/06/mental_health_and_recovery_licking_counties.jpg"
                                                 style="padding: 8px; background: #ffffff"
                                                 class="img-responsive grayscale">
                                        </a>
                                        <div style="height: 15px"></div>
                                        <a href="http://www.unitedway.org/" target="_blank">
                                            <img src="http://lapp.cc/wp-content/uploads/2014/06/united_way_licking_county.jpg"
                                                 class="img-responsive grayscale"
                                                 style="padding: 8px; background: #ffffff">
                                        </a>
                                    </div>
                                ...
                                <a href="http://mha.ohio.gov/" class="grayscale"><img class="img-responsive"
                                                                                      src="http://lapp.emf-hosting.com/wp-content/uploads/2014/06/mhas.jpg"
                                                                                      style="background: #ffffff; width: 100%"></a>
                            </div>
                        </aside>
                    </div>
                    <div id="footer-sidebar2" class='col-sm-4'>
                        <aside id="text-3" class="widget widget_text"><h3 class="widget-title">Contact Info</h3>
                            <div class="textwidget">
                                <ul class='footer-contact-info'>
                                    <li>
                                        <div class='row'>
                                            <div class='col-xs-8'>
                                                62 East Stevens St.<br>
                                                Newark, OH 43055
                                            </div>
                                            <div class='col-xs-4'>
                        ...
                        <aside id="text-4" class="widget widget_text"><h3 class="widget-title">Certifications</h3>
                            <div class="textwidget">
                                <ul class='footer-contact-info'>
                                    ...
                                    <li>
                                        <a href="http://www.carf.org/" target="_blank"><img
                                                    src="http://lapp.cc/wp-content/uploads/2014/09/CARF_GoldSeal_144px.png"
                                                    class="img-responsive grayscale"></a>
                                    </li>
                                </ul>
                            </div>
                        </aside>
    ...
    <div class="white_background">
        <div class='container'>
            <div class='row'>
                <div class='col-sm-4'>
                    <div class='copyright'>
                        Copyright &copy; 2017 Licking County Alcoholism Prevention Program All Rights Reserved
                    </div>
                    <div class='copyright'>
                        Developed By <a href='www.emf-websolutions.com'>EMF Web Solutions</a> | Utica, Ohio
                    </div>
                </div>
                <div class='col-sm-8 text-center footer_links'>
                    <div class="bottomMenu">
                        <div class="menu-footer-container">
                            <ul id="menu-footer" class="menu">
                                <li id="menu-item-466"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-466">
                                    <a href="http://lapp.cc/">Home</a></li>
                                <li id="menu-item-477"
                                ...
                                <li id="menu-item-501"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-501"><a
                                            href="http://lapp.cc/programs/">Programs</a></li>
                                <li id="menu-item-505"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-505"><a
                                            href="http://lapp.cc/development/">Development</a></li>
                                <li id="menu-item-502"
                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-21 current_page_item menu-item-502">
                                    <a href="http://lapp.cc/aana-meetings/">AA/NA Meetings</a></li>
                                <li id="menu-item-503"
                                ...
                                <li id="menu-item-504"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-504"><a
                                            href="http://lapp.cc/contact-locations/">Contact</a></li>
                                <li id="menu-item-506"
