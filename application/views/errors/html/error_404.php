...
<!-- Bootstrap -->
<script src="<?php echo base_url('lapp/assets/themes/admin/vendors/bootstrap/dist/js/bootstrap.min.js'); ?>"></script>
<!-- FastClick -->
<script src="<?php echo base_url('lapp/assets/themes/admin/vendors/fastclick/lib/fastclick.js'); ?>"></script>
<!-- NProgress -->
