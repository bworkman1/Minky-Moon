 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'jjw2501-facilitator_api1.yahoo.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1377882281' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AqtH8araME.3MsvNJ0UbrC-sZKGQ' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'brian@emf-websolutions.com';
